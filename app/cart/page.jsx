...
const Cart = () => {
  ...
  return (
    <>
      <Navbar />
      <div className="flex flex-col md:flex-row gap-10 px-6 md:px-16 lg:px-32 pt-14 mb-20 bg-slate-900 text-white min-h-screen">
        <div className="flex-1">
          ...
          <div className="overflow-x-auto">
            <table className="min-w-full table-auto">
              <thead className="text-left text-slate-400">
                <tr>
                  <th className="text-nowrap pb-6 md:px-4 px-1 font-medium">Product Details</th>
              ...
              <tbody>
                {Object.keys(cartItems).map((itemId) => {
                  ...
                  return (
                    <tr key={itemId} className="text-slate-200">
                        ...
                        <div>
                          <div className="rounded-lg overflow-hidden bg-slate-800 p-2">
                            <Image
                              src={product.image[0]}
                              alt={product.name}
                              className="w-16 h-auto object-cover mix-blend-screen"
                              width={1280}
                              height={720}
                            />
                          </div>
                      ...
                      <td className="py-4 md:px-4 px-1">
                        <div className="flex items-center md:gap-2 gap-1">
                          ...
                          <input
                            ...
                            className="w-8 border bg-slate-800 border-slate-600 text-center text-white appearance-none"
                          />
          ...
          <button
            ...
            className="group flex items-center mt-6 gap-2 text-blue-500"
          >
            <Image
